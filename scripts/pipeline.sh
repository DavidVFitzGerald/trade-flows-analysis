...
bash run_pyspark_job.sh "${HS_code}" convert_to_parquet.py
...
bash run_pyspark_job.sh "${HS_code}" calculate_trade_per_country.py
...
bash run_pyspark_job.sh "${HS_code}" calculate_trade_per_HS_code.py
